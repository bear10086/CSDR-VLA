...
def run_maniskill2_eval_single_episode(
    ...
    while not (predicted_terminated or truncated):
        ...
        # The repository's locked ManiSkill2 submodule does not expose eef_pos.
        # SpatialVLA accepts and ignores this optional keyword, so a nullable read
        # is behavior-preserving while keeping the official evaluator runnable.
        raw_action, action = model.step(image, task_description, eef_pos=obs["agent"].get("eef_pos"))
