...
class TurboVLAActionHead(nn.Module):
    ...
    def forward(
        ...
        return self.decoder(
            torch.cat([vision_language_tokens, state_tokens], dim=1), return_hidden=return_hidden
        )
