...
def _checkpoint_state_dict(checkpoint: Any) -> dict[str, torch.Tensor]:
    ...
    # RoboTwin releases EMA weights, while the official unified LIBERO
    # checkpoint is documented and distributed with model_state_dict.
    ...
    if isinstance(model_state, dict):
        return model_state
    raise KeyError("checkpoint contains neither ema_model_state_dict nor model_state_dict")
