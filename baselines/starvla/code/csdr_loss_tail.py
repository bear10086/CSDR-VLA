...
class CSDRConfig(BaseConfig):
    ...
    # Ordered rows for lengths 1..16, columns translation/rotation/gripper.
...
def spatialvla_csdr_loss(action_hidden_states, actions, context_signatures, action_errors,
    ...
    violation = F.relu(distance.gather(1, near)[:, :, None] + cfg.order_margin
                       - distance.gather(1, far)[:, None, :])
