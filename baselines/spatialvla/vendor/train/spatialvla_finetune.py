...
from cohort_planning.baseline_adapters import BridgeSpatialVLAWindowTransform
...
def main():
    ...
    if data_args.planned_cohort_data_dir is not None:
        ...
        planned_transform = BridgeSpatialVLAWindowTransform(
            processor=processor,
            statistics_path=statistics_paths[0],
            image_size=train_dataset.image_size,
            max_length=data_args.max_seq_length,
            image_aug=True,
            include_action_valid_length=True,
        )
    ...
    if model_args.csdr and data_args.planned_cohort_data_dir is None:
        raise ValueError("This release requires a full-coverage --planned_cohort_data_dir.")
